...
.add(StrictAddition('o_uint64', 'i_uint64', 'l_uint64'))
.add(StrictAddition('o_uint32', 'l_uint32', 'i_uint32'))
.add(StrictAddition('o_uint16', 'i_uint16', 'l_uint16'))
.add(StrictAddition('o_uint8', 'l_uint8','i_uint8'))
.add(SendBack())
)  
